...
import { Eye, EyeOff, TrendingUp, TrendingDown, Sparkles, Wallet } from 'lucide-react';
    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-card/90 via-card/70 to-card/90 backdrop-blur-2xl border border-primary/30 rounded-3xl p-6 shadow-[0_12px_40px_rgba(0,210,210,0.1)]">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-[10px] font-mono text-muted-foreground uppercase tracking-widest block leading-none">
                Virtual Trading Balance
              </span>
              <span className="text-[9px] font-mono text-emerald-400 font-semibold uppercase tracking-wider block mt-0.5">
        ...
        <div className="mb-5 flex flex-wrap items-baseline justify-between gap-2">
          ...
          <button
            ...
            className="text-xs font-mono font-semibold text-primary hover:underline flex items-center gap-1 cursor-pointer"
          >
            <Wallet className="w-3.5 h-3.5" />
            <span>Open Wallet & History →</span>
          </button>
        </div>
